...
3. 목록에서 원하는 선수를 클릭하면 오른쪽에 현재 공식 미페가 표시됩니다.
   - **공식 미페 / 현재 미페** 토글로 서버 원본과 현재 로컬 파일을 비교할 수 있습니다.
...
[Releases 페이지](https://github.com/HazySound/MFChanger/releases)에서 최신 버전을 받을 수 있습니다.
