...
**Step 2.** FC온라인 홈페이지에 변경 사항이 반영될 때까지 잠시 기다립니다.

**Step 3.** 홈페이지 내 자신의 프로필에 표시되는 크레스트 아이콘을 우클릭 → 다른 이름으로 저장해 파일명을 확인합니다.

**Step 4.** 파일명을 복사해 입력란에 붙여넣습니다.

> 각 단계별 상세 이미지는 추후 추가 예정입니다.
